                            ...
                            <Row className="mt-n2 mb-3 mb-sm-0">
                                    ...
                                    <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                        ...
                                        <div id="email-topbar-actions" style={{ display: "none" }}>
                                            <div className="hstack gap-sm-1 align-items-center flex-wrap">
                                                <button type="button" className="btn btn-ghost-secondary material-shadow-none btn-icon btn-sm fs-16" id="Tooltip1">
                                                    <i className="ri-inbox-archive-fill align-bottom"></i>
                                                </button>
                                                <button type="button" className="btn btn-ghost-secondary material-shadow-none btn-icon btn-sm fs-16" id="Tooltip2">
                                                    <i className="ri-error-warning-fill align-bottom"></i>
                                                </button>
                                                <button type="button" className="btn btn-ghost-secondary material-shadow-none btn-icon btn-sm fs-16" id="Tooltip3" onClick={() => { setDeleteModal(true); }} >
                                        ...
                                        <UncontrolledDropdown>
                                            <DropdownToggle tag="button" className="btn btn-ghost-secondary material-shadow-none btn-icon btn-sm fs-16">
                                ...
                                <div className="col-auto order-2 order-sm-3">
                                    <div className="d-flex gap-sm-1 email-topbar-link">
                                        <button type="button" className="btn btn-ghost-secondary material-shadow-none btn-icon btn-sm fs-16">
                        ...
                        <div className="pb-4 border-bottom border-bottom-dashed">
                            <Row>
                                ...
                                <Col className="col-auto">
                                    <div className="hstack gap-sm-1 align-items-center flex-wrap email-topbar-link">
                                        <button type="button" className="btn btn-ghost-secondary btn-icon btn-sm fs-16 favourite-btn active material-shadow-none">
                                            <Rating
                                                stop={1}
