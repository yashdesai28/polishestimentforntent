            ...
            <TabContent activeTab={activeTab}>
              <TabPane tabId={1}>
                <Row className="g-3">
                  ...
                  <Col lg={6}>
                    <div>
                      <Label htmlFor="serviceTax" className="form-label">
                        Service Tax No.
                      </Label>
                      <Input
                        type="text"
              ...
              <TabPane tabId={3}>
                ...
                <div className="d-flex gap-2">
                  <div>
                    ...
                    />
                    <Label className="btn btn-outline-info" htmlFor="passport">
                      Passport
                    </Label>
                  </div>
                  <div>
                    <Input
                      ...
                      name="choose-document"
                    />
                    <Label className="btn btn-outline-info" htmlFor="aadhar-card">
                      Aadhar Card
                    </Label>
                  </div>
                  <div>
                    <Input
                      ...
                      name="choose-document"
                    />
                    <Label className="btn btn-outline-info" htmlFor="pan-card">
                      Pan Card
                    </Label>
                  </div>
                  <div>
