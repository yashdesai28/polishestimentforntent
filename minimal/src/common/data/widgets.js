...
const tileBoxs3 = [
    ...
    },
    {
        ...
        labelClass: "white-50",
        counterClass: "text-white",
        badgeClass: "badge bg-white bg-opacity-25 text-white mb-0",
        badge: "ri-arrow-down-line",
        percentage: "0.24 %",
        iconClass: "white bg-opacity-25",
        feaIcon: "clock",
...
const tileBoxes4 = [
    {
        ...
        bgColor: "bg-primary",
        icon: "bx bx-shopping-bag",
        iconClass: "white bg-opacity-25 text-white",
        label: "Total Sales",
        labelClass: "white-50",
        counter: "2045",
        counterClass: "text-white",
        ...
        percentage: "6.11 %",
        percentageClass: "badge bg-white bg-opacity-25 text-white mb-0",
