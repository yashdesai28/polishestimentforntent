                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className='text-muted'>Change the alpha opacity of the link <code>rgba()</code> color value with utilities. Please be aware that changes to a color’s opacity can lead to links with <Link href="https://getbootstrap.com/docs/5.3/getting-started/accessibility/#color-contrast" target="_blank"><em>insufficient</em> contrast</Link>.</p>
                                    <div className='live-preview'>
